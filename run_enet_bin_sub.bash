python fp_models/enet/run_bin_sub.py --data_name 'cityscapes' --data_path '../../data/cityscapes/' \
...
--experiment_path 'fp_models/enet/sub_bin_experiments/' --experiment_name 'bedn_sub_cityscapes_test_final' --device 'cuda' \
--seed 4 --decay_val 0.9 --decay_step 10 --use_weights 1

exp_path='fp_models/enet/sub_bin_experiments/'
