...
--batch_size 4 --image_size 448 --num_of_classes 3 --train_subset 10 --val_subset 10 \
...
--stem_channels 15 --nodes_num 3 --edge_num 2 --ops_num 6 --network_final_layer 'bin' \
--experiment_path 'search/bnas/experiments/' --experiment_name 'bnas_3n_subset_test' --device 'cuda' \
...
--bnas_t 4 --bnas_sample_epochs 4 --latency_gamma 0.1 --params_delta 0.1 --theta_ops 0.1 \
--required_latency_ms 2 --required_params_size_kb 100 --required_ops_mops 50 \
--arch_v_epochs 4 --arch_t_epochs 4

exp_path='search/bnas/experiments/'
exp_name='bnas_3n_subset_test'
exp_path+=$exp_name
