...
--stem_channels 30 --nodes_num 4 --edge_num 2 --ops_num 6 --network_final_layer 'bin' \
--experiment_path 'search/bnas/experiments/' --experiment_name 'test1_reproducability' --device 'cuda' \
...
--arch_v_epochs 2 --arch_t_epochs 3

exp_path='search/bnas/experiments/'
exp_name='test1_reproducability'
exp_path+=$exp_name
