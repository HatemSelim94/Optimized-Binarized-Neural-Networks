...
exp_name='final_paper_model_b_crossval'
exp_path+=$exp_name
rm -r $exp_path
mkdir -p $exp_path
cp run_road.bash $exp_path

python eval/darts/run_road_crossval.py --batch_size 8 --num_of_classes 2 \
...
--stem_channels 30 --nodes_num 5 --edge_num 2 \
--experiment_path 'eval/darts/road_experiments/' --experiment_name 'final_paper_model_b_crossval' --device 'cuda' \
...
--use_maxpool 0 --merge_type 'sum' --optimize_merge 0 --k 5
