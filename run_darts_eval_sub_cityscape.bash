...
# merge_type ['sum','conv']
#h1024, w2048
python eval/darts/run_sub.py --data_name 'cityscapes' \
...
--stem_channels 100 --nodes_num 4 --edge_num 2 \
--experiment_path 'eval/darts/cityscapes_experiments/' --experiment_name 'cityscapes_sub_arch_a_last_layer_fp' --device 'cuda' \
--seed 4 --affine 1 --binary 1 --last_layer_binary 0 --last_layer_kernel_size 1 \
...
--channel_expansion_ratio_r 0.5 --channel_reduction_ratio_u 10 --channel_normal_ratio_n 0.3 \
...
exp_path='eval/darts/cityscapes_experiments/'
exp_name='cityscapes_sub_arch_a_last_layer_fp'
exp_path+=$exp_name
cp run_darts_eval_sub_cityscape.bash $exp_path