...
--stem_channels 60 --nodes_num 5 --edge_num 2 \
--experiment_path 'eval/darts/experiments/' --experiment_name 'max_pool_in_5_nodes' --device 'cuda' \
--seed 4 --affine 1 --binary 1 --last_layer_binary 1 --last_layer_kernel_size 3 \
--genotype_path 'search/darts/experiments/' --search_exp_name 'max_pool_in_5_nodes' --generate_jit 1 --generate_onnx 1 \
...
--poly_scheduler 0 --lr_auto 0 --decay_val 0.5 --decay_step 5  --binary_aspp 1 --use_weights 1
