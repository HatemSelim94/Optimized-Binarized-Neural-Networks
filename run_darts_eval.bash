...
--experiment_path 'eval/darts/experiments/' --experiment_name 'r_u_full_net' --device 'cuda' \
--seed 4 --affine 1 --binary 1 --last_layer_binary 1 --last_layer_kernel_size 3 \
--genotype_path 'search/darts/experiments/' --search_exp_name 'r_u_full' --generate_jit 1 --generate_onnx 1 \
--padding_mode 'zeros' --dropout2d_prob 0.2 --network_type 'cells' --binarization 1 --use_skip 1 \
--activation 'htanh' --first_layer_activation 'htanh' --step_two 0 --seaborn_style 0

exp_path='eval/darts/experiments/'
exp_name='r_u_full_net'
exp_path+=$exp_name
