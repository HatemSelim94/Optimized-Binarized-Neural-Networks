...
--network_optim_fp_weight_decay 5e-4 --network_optim_bin_betas 0.9 --network_sequence 'r,r,n,n,n,n' \
--stem_channels 80 --nodes_num 4 --edge_num 2 \
--experiment_path 'eval/darts/experiments/' --experiment_name 'test_new_2_seq2' --device 'cuda' \
--seed 4 --affine 1 --binary 1 --last_layer_binary 1 --last_layer_kernel_size 1 \
--genotype_path 'search/darts/experiments/' --search_exp_name 'new_test_2' --generate_jit 1 --generate_onnx 1 \
--padding_mode 'zeros' --dropout2d_prob 0.0 --network_type 'aspp' --binarization 1 --use_skip 0 \
