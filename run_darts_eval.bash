...
--batch_size 10 --image_size 448 --num_of_classes 3 --train_subset 10 --val_subset 10 \
--epochs 2 --network_optim 'Adam' --network_optim_bin_lr 1e-2 --network_optim_fp_lr 1e-4 \
