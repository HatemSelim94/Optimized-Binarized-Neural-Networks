...
--experiment_path 'search/darts/experiments/' --experiment_name 'kd_exp_affine_on' --device 'cuda' \
--seed 4 --arch_start 5 --both 1 --affine 1 --binary 1 --ops_obj_beta 0.0 --params_obj_gamma 0.0 \
--latency_obj_delta 0.0001 --last_layer_binary 1 --last_layer_kernel_size 1 \
