...
Upsampling_OPS = {
  ...
  'bilinear_upsample' : lambda  C, stride, affine:  nn.Sequential(nn.Upsample(scale_factor=stride, mode='bilinear', align_corners=False),BnnConv(C, C, 1, 1, affine=affine)),
