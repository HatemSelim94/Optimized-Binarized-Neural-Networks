...
--batch_size 16 --image_size 448 --num_of_classes 3 --train_subset 200 --val_subset 200 \
...
--stem_channels 20 --nodes_num 4 --edge_num 2 --ops_num 6 \
--experiment_path 'search/darts/experiments/' --experiment_name 'max_pool_pure_bin_4_n' --device 'cuda' \
...
exp_name='max_pool_pure_bin_4_n'
exp_path+=$exp_name
