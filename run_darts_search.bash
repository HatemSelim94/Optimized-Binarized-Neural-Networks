...
--epochs 30 --network_optim 'Adam' --network_optim_bin_lr 1e-2 --network_optim_fp_lr 1e-3 \
--network_optim_fp_weight_decay 5e-4 --network_optim_bin_betas 0.9 --network_sequence 'r,r,r,n,u' \
--stem_channels 15 --nodes_num 5 --edge_num 2 --ops_num 6 \
--experiment_path 'search/darts/experiments/' --experiment_name 'max_pool_in_5_nodes' --device 'cuda' \
--seed 4 --arch_start 5 --both 1 --affine 0 --binary 1 --ops_obj_beta 0 --params_obj_gamma 0 \
--latency_obj_delta 0 --last_layer_binary 3 --last_layer_kernel_size 3 \
