...
--batch_size 16 --image_size 448 --num_of_classes 19 --train_subset 300 --val_subset 300 \
...
--stem_channels 25 --nodes_num 4 --edge_num 2 --ops_num 6 \
--experiment_path 'search/darts/experiments/' --experiment_name 'sub_search_exp_4' --device 'cuda' \
--seed 4 --arch_start 5 --both 1 --affine 0 --binary 1 --ops_obj_beta 0 --params_obj_gamma 0 \
--latency_obj_delta 0 --last_layer_binary 1 --last_layer_kernel_size 1 \
...
--channel_normal_ratio_n 0.25  --binary_aspp 1 --use_maxpool 1

exp_path='search/darts/experiments/'
exp_name='sub_search_exp_4'
exp_path+=$exp_name
