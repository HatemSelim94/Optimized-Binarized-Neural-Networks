...
--experiment_path 'search/darts/experiments/' --experiment_name 'fp_search_4_nodes' --device 'cuda' \
--seed 4 --arch_start 5 --both 1 --affine 0 --binary 0 --ops_obj_beta 0 --params_obj_gamma 0 \
--latency_obj_delta 0 --last_layer_binary 0 --last_layer_kernel_size 3 \
