...
--stem_channels 15 --nodes_num 4 --edge_num 2 --ops_num 6 \
--experiment_path 'search/darts/experiments/' --experiment_name 'pure_bin_exp_3' --device 'cuda' \
