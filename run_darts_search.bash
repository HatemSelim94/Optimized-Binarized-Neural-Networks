...
--epochs 61 --network_optim 'Adam' --network_optim_bin_lr 1e-3 --network_optim_fp_lr 1e-5 \
...
--experiment_path 'search/darts/experiments/' --experiment_name 'r_u_full_test' --device 'cuda' \
...
--dropout2d_prob 0.001 --seaborn_style 0

exp_path='search/darts/experiments/'
exp_name='r_u_full_test'
exp_path+=$exp_name
