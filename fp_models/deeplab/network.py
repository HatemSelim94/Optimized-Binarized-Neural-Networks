...
class ConvBnReLU(nn.Sequential):
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1, padding=0, dilation=1, activation='relu'):
...
class Decoder(nn.Module):
    def __init__(self, encoder_output_channels = 256, low_level_features_channels=64): 
        ...
        self.second_conv3_3 = ConvBnReLU(256, 256, 3, padding=1, activation='relu')  # "it is more effective to employ two 3×3 convolution with 256 filters than using simply one or three convolutions"https://arxiv.org/pdf/1802.02611.pdf sec4.1
