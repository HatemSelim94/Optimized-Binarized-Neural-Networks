...
import os
import ptflops
from model import EESPNet_Seg as Network
...
parser  = argparse.ArgumentParser('ESPNET')
...
parser.add_argument('--experiment_path', type=str, default='fp_models/espnet/experiments/')
...
#FP
# 2.6 MB, 0.64GMACs | 8#cls miou: 70%   kitti
# latency: 4.84 | FPS: 206
...
def main():
    ...
    macs, params = ptflops.get_model_complexity_info(net, (3, args.image_size, args.image_size))
