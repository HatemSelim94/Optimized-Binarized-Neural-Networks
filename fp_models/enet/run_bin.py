...
def main():
    ...
    ##
    print('ptflops')
    macs, params = get_model_complexity_info(net, (3, args.image_size, args.image_size), as_strings=True,
    ...
    conv_count= [0]
    def rec(net, conv_count):
        for layer in net.children():
            if isinstance(layer, nn.Conv2d):
                conv_count[0] +=1
            else:
                rec(layer, conv_count)
    rec(net, conv_count)
    print(f'conv layer count: {conv_count[0]}')
