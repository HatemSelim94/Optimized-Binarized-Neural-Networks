...
from fp_models.enc_dec.network import Network
...
parser  = argparse.ArgumentParser('EncoderDecoder')
...
parser.add_argument('--experiment_path', type=str, default='fp_models/enc_dec/experiments/')
...
def main():
    ...
    val_dataset = Subset(train_dataset, [i for i in val_idx])
